                    ...
                    <AutoColumn gap="sm">
                      ...
                      {showWrap ? null : (
                        <AutoColumn gap="7px" style={{ padding: '0 16px' }}>
                          ...
                          <RowBetween align="center">
                            <Label>{t('Token Trade Slippage')}</Label>
                    ...
                    <Box mt="0.25rem">
                      {swapIsUnsupported ? (
                        ...
                        <GreyCard style={{ textAlign: 'center', padding: '0.75rem' }}>
                          <Text color="textSubtle">{t('Cannot make trade due to Insufficient liquidity.')}</Text>
                          {singleHopOnly && <Text color="textSubtle">{t('Try again soon.')}</Text>}
                        </GreyCard>
                      ) : showApproveFlow ? (
                        <RowBetween>
                          <Button
                          ...
                          >
                            {approval === ApprovalState.PENDING ? (
                              <AutoRow gap="6px" justify="center">
                                {t('Authorizing')} <CircleLoader stroke="white" />
                              </AutoRow>
                            ) : approvalSubmitted && approval === ApprovalState.APPROVED ? (
                              t('Authorize')
                            ) : (
                              t('Authorize %asset%', { asset: currencies[Field.INPUT]?.symbol ?? '' })
                            )}
                          </Button>
                          <Button
