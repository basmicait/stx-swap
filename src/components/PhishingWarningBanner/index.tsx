...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://sectorprotocol.io - check the URL carefully.")
  const warningTextAsParts = warningText.split(/(https:\/\/sectorprotocol.io)/g)
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://sectorprotocol.io'}
          color={text === 'https://sectorprotocol.io' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
